package com.tony.admin.web.im.model.proto;
// Generated by the protocol buffer compiler.  DO NOT EDIT!
// source: MessageBody.proto

public final class MessageBodyModel {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return MessageBodyModel.internal_static_MessageBody_descriptor;
    }

    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return MessageBodyModel.internal_static_MessageBody_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              MessageBodyModel.MessageBody.class, MessageBodyModel.MessageBody.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof MessageBodyModel.MessageBody)) {
        return super.equals(obj);
      }
      MessageBodyModel.MessageBody other = (MessageBodyModel.MessageBody) obj;
    ...
    public static MessageBodyModel.MessageBody parseFrom(
    ...
    public static MessageBodyModel.MessageBody parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static MessageBodyModel.MessageBody parseFrom(
    ...
    public static MessageBodyModel.MessageBody parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static MessageBodyModel.MessageBody parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static MessageBodyModel.MessageBody parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(MessageBodyModel.MessageBody prototype) {
    ...
    public static final class Builder extends
        ...
        MessageBodyModel.MessageBodyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return MessageBodyModel.internal_static_MessageBody_descriptor;
      }
      ...
      // Construct using MessageBodyModel.MessageBody.newBuilder()
      private Builder() {
      ...
      public MessageBodyModel.MessageBody getDefaultInstanceForType() {
        return MessageBodyModel.MessageBody.getDefaultInstance();
      }

      public MessageBodyModel.MessageBody build() {
        MessageBodyModel.MessageBody result = buildPartial();
      ...
      public MessageBodyModel.MessageBody buildPartial() {
        MessageBodyModel.MessageBody result = new MessageBodyModel.MessageBody(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof MessageBodyModel.MessageBody) {
          return mergeFrom((MessageBodyModel.MessageBody)other);
        } else {
      ...
      public Builder mergeFrom(MessageBodyModel.MessageBody other) {
        if (other == MessageBodyModel.MessageBody.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        MessageBodyModel.MessageBody parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (MessageBodyModel.MessageBody) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final MessageBodyModel.MessageBody DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new MessageBodyModel.MessageBody();
    }

    public static MessageBodyModel.MessageBody getDefaultInstance() {
